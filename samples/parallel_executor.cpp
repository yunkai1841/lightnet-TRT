...
int main(int argc, char **argv) {
    gflags::SetUsageMessage(
        "Usage : trt-yolo-app --flagfile=</path/to/config_file.txt> "
        "--<flag>=value ...");
    ...
    config1.calibration_image_list_file_txt =
    "../configs/calibration_images.txt"; if (yoloInfo1.precision == "kHALF") {
    ...
    */
    ...
    config2.file_model_weights =
        yoloInfo2
            .wtsFilePath;  //"../configs/yolov7-tiny-relu-BDD100K-960x960-opt-params-mse-sparse_last.weights";
    config2.calibration_image_list_file_txt =
        "../configs/calibration_images.txt";
