...
class SimpleProfiler : public nvinfer1::IProfiler {
   public:
     ...
     *  src_profilers:  Optionally initialize profiler with data of one or more
     * other profilers This is usefull for aggregating results of different
     * profilers Aggregation will sum all runtime periods and all invokations
     * for each reported layer of all given profilers
     */
