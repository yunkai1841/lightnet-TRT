...
__global__ void SimpleblobFromImageKernel(int N, float* dst_img,
                                          unsigned char* src_img, int dst_h,
                                          int dst_w, int src_h, int src_w,
...
void blobFromImageGpu(float* dst, unsigned char* src, int d_w, int d_h, int d_c,
                      int s_w, int s_h, int s_c, float norm,
                      cudaStream_t stream) {
    int N = d_w * d_h;
